...
function ProductDetail() {
  ...
  return (
    <div className="container mx-auto p-4 md:p-8 max-w-7xl">
      <button
        onClick={() => navigate(-1)}
        className="mb-4 text-red-600 hover:text-red-800 font-semibold"
      >
            ...
            {displayPrice.discounted ? (
              <>
                <p className="text-2xl text-gray-500 line-through">
                  {t("productDetail.regularPrice")}: {displayPrice.original} kr
                </p>
                <p className="text-4xl font-extrabold text-green-600">
                  {t("productDetail.yourPrice")}: {displayPrice.discounted} kr
                </p>
              </>
            ) : (
